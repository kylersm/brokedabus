...
export default function Button(props: { 
  ...
  return <div 
    ...
    className={"mx-auto w-fit " + (props.color ?? Color.GRAY) + " cursor-pointer text-white px-3 py-2 rounded-lg my-3 shadow-md shadow-neutral-300 dark:shadow-neutral-600 active:shadow-inner"}
  >
    {props.children}
  </div>;
}
